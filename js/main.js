...
document.addEventListener('DOMContentLoaded',function(event){ 
    var dataText = ["SIEMPRE EN TUS MEJORES MOMENTOS", "SIEMPRE EN TUS MEJORES MOMENTOS", "SIEMPRE EN TUS MEJORES MOMENTOS","SIEMPRE EN TUS MEJORES MOMENTOS","SIEMPRE EN TUS MEJORES MOMENTOS","SIEMPRE EN TUS MEJORES MOMENTOS"];
 function typeWriter(text, i, fnCallback){ 
 if (i < (text.length)) {
     document.querySelector("h2").innerHTML = text.substring(0, i+1) +'<span aria-hidden="true"></span>'; setTimeout(function() {
